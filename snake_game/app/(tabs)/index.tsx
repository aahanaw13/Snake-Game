...
const CELL_SIZE: number = Math.floor(
  Math.min(Dimensions.get('window').width, Dimensions.get('window').height - 200) / GRID_SIZE
);
const GAME_SPEED: number = 150; // milliseconds
